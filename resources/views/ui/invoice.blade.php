...
<div><span class="text-right" style="color: purple; font-weight: bold;font-size: 17px; width: 50%; float: right;">Contact: 0705731168</span></div>
    			<div><p><span class="my-auto text-right" style="color: blue; font-weight: bold;font-size: 15px; float: left;">
    			 <?php
$t=time();
echo("Invoice Number ".$t . "<br>");
?></span></p></div>
...
<p class="text-center " style="color: black;">
	Thank you and Welcome Again!
    		...
    		<div class="col-sm-12 col-lg-8 col-md-8" style="margin: 20px;">
    			<button style="float: right;" class="text-center btn btn-success" onclick="return printDiv();" type="button">print Invoice</button>
    		</div>
    	</div>
    </div>
