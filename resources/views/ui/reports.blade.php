						...
						<div class="row" >
							<div class="col-sm-12 col-lg-12 col-md-12" style="height: 80vh;overflow: scroll;"  >
								<div class="container col-12">
									<div class="row">
									<form action="repo" method="post" class="form-inline col-10 container">
										<div class="row">
											@csrf
							...
							@enderror </span>
										...
										<div class="form-group col-3" >
											<button type="submit" class="btn btn-success form-control col-12">generate</button>
										</div>
										</div>
									</form>
<div class="col-2 text-center "><button class="btn btn-secondary mt-3 col-12" onclick="CreatePDFfromHTML();">Export</button></div>
								</div></div>
									<div class="div1">
